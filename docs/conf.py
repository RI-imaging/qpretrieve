...
# -*- coding: utf-8 -*-
#
# qpretrieve documentation build configuration file, created by
...
if "READTHEDOCS_VERSION" in os.environ:
    ...
    rtd_version = "latest"
# Used for linking to libraries in the qpretrieve universe
...
rst_prolog = """
:github_url: https://github.com/RI-imaging/qpretrieve
"""
...
bibtex_bibfiles = ['qpretrieve.bib']
...
# This gets 'version'
version = qpretrieve.__version__
release = version
...
htmlhelp_basename = 'qpretrievedoc'
...
latex_documents = [
    (master_doc, 'qpretrieve.tex', 'qpretrieve Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'qpretrieve', 'qpretrieve Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qpretrieve', 'qpretrieve Documentation',
     author, 'qpretrieve', 'Quantitative phase image management',
     'Scientific'),
]
...
intersphinx_mapping = {
    ...
    "qpimage": ('http://qpformat.readthedocs.io/en/'+rtd_link, None),
